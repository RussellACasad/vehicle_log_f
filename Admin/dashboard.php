...
<body>
    ...
    <div class="body dash"> <!-- The code for the sidebar buttons -->
        <div class="sidebar">
            <ul>
                <li>
                    <a class="button lg <?= $action == 'home' ? "selected" : "" ?>" href="./Admin/?action=home">
                        <p class="icon">&#xE2C2</p>
                        <p class="nav-text">Home</p>
                    </a>
                </li>
                <li>
                    <a class="button lg <?= $action == 'vehicles' || $action == 'info' || $action == 'gas' || ($action == 'maint' && !isset($return)) ? "selected" : "" ?>" href="./Admin/?action=vehicles">
                        <p class="icon">&#xE8CC</p>
                        <p class="nav-text">Vehicles</p>
                    </a>
                </li>
                <li>
                    <a class="button lg <?= $action == 'maintenence' || ($action == 'maint' && isset($return)) ? "selected" : "" ?>" href="./Admin/?action=maintenence">
                        <p class="icon">&#xE5D4</p>
                        <p class="nav-text">Maintenence</p>
                    </a>
                </li>
                <li>
                    <a class="button lg <?= $action == 'users' ? "selected" : "" ?>" href="./Admin/?action=users">
                        <p class="icon">&#xE4D6</p>
                        <p class="nav-text">Users</p>
                    </a>
                </li>
                <li>
                    <a class="button lg <?= $action == 'about' ? "selected" : "" ?>" href="./Admin/?action=about">
