        ...
        <form method="post" action="./Admin/AddEditMaintenanceController.php">
            <div class="maint form">
                <div style="grid-area: vendor;">
                    ...
                    <input maxlength="50" required type="text" id="vendor" name="vendor" value="<?= $maintLog["Vendor"] ?>" onblur="validate('vendor')">
                </div>
                <div style="grid-area: vendorAddress;">
                    <label for="vendorAddress">Vendor Address</label>
                    <input maxlength="255" required type="text" id="vendorAddress" name="vendorAddress" value="<?= $maintLog["VendorAddress"] ?>" onblur="validate('vendorAddress')">
                </div>
                <div style="grid-area: desc;">
                    <label for="desc">Description</label>
                    <input maxlength="255" required type="text" id="desc" name="desc" value="<?= $maintLog["Description"] ?>" onblur="validate('desc')">
                </div>
                <div style="grid-area: cost;">
                    <label for="cost">Total Cost</label>
                    <input max="99999999.99" min="0.00" required type="number" step="0.01" id="cost" name="cost" value="<?= $maintLog["TotalCost"] ?>" onblur="validate('cost', 0, 99999999.99)">
                </div>
                <div style="grid-area: milesBefore;">
                    <label for="milesBefore">Mileage Before</label>
                    <input max="99999999.99" min="0.00" required type="number" step="0.01" id="milesBefore" name="milesBefore" value="<?= $maintLog["MileageBefore"] ?>" onblur="validate('milesBefore', 0, 99999999.99)">
                </div>
                <div style="grid-area: milesAfter;">
                    <label for="milesAfter">Mileage After</label>
                    <input max="99999999.99" min="0.00" type="number" id="milesAfter" step="0.01" name="milesAfter" value="<?= $maintLog["MileageAfter"] ?>">
                </div>
        ...
        <div class="modal-message">
            ...
            <div class="buttons">
                <form action="./Admin/DeleteController.php">
                    <input type="hidden" value="maint" name="action">
                    <input type="hidden" value="<?= $maintLog["MaintenanceID"] ?>" name="id">
...
<body>
    <div class="p-10">
        <div class="info-head">
            <a href="./Admin/?action=<?= isset($return) ? "maintenence" : "info&id=" . $maintLog["VehicleID"] ?>" class="icon button">&#xE138</a>
