...
$sql = "SELECT * 
        ...
        WHERE Maintenance.VehicleID = Vehicles.VehicleID AND Maintenance.MileageAfter IS NULL AND Maintenance.Started = 1
...
$sql = "SELECT * 
        FROM Maintenance, Vehicles 
        WHERE Maintenance.VehicleID = Vehicles.VehicleID AND Maintenance.Started = 1
        ORDER BY Maintenance.Date DESC";
$statement = $db->prepare($sql);
$statement->execute();
...
$sql = "SELECT * 
        FROM Maintenance, Vehicles 
        WHERE Maintenance.VehicleID = Vehicles.VehicleID AND Maintenance.Started = 0
        ORDER BY Maintenance.Date DESC";
$statement = $db->prepare($sql);
$statement->execute();
...
// Gets all fuel logs
$fuelsql = "SELECT * FROM Fuel, Vehicles WHERE Fuel.VehicleID = Vehicles.VehicleID";
