        ...
        <form method="post" action="./User/AddEditVehicleController.php">
            <div class="vehicle form">
                ...
                <div style="grid-area: miles;">
                    ...
                    <input required max="99999999.99" min="0.00" type="number" step="0.01" id="miles" name="miles" onblur="validate('number', 0, 99999999.99)">
                </div>
        ...
        <tbody>
            <?php if (count($Vehicles) > 0): ?>
                <?php foreach ($Vehicles as $Vehicle): ?>
                    <tr class="lined">
                        <td><a href="./User/?action=info&id=<?= $Vehicle["VehicleID"] ?>"><?= $Vehicle["Year"] . " " . $Vehicle["Brand"] . " " . $Vehicle["Model"] ?></a></td>
                        <td><?= $Vehicle["Color"] ?></td>
